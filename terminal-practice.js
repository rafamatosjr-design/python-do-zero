(() => {
  ...
  const exercises = [
    ...
    {id:5,language:'Python',level:'Intermediário',title:'Repetições',concept:'for repete uma ação. Em range(1, 7), o primeiro número entra e o último não: por isso o resultado vai de 1 a 6.',command:'python main.py',file:'main.py',task:'Mostre os números de 1 a 6 usando apenas um print dentro de uma repetição.',starter:'# Mostre os números de 1 a 6\n',checks:['for i in range(1, 7):','\n    print(i)'],hint:'Use exatamente esta estrutura: for i in range(1, 7): e, na linha seguinte, dê 4 espaços antes de print(i).',success:'Você mostrou os números de 1 a 6 usando uma repetição e a indentação correta.'},
